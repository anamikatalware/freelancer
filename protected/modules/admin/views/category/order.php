<?php $this->pageTitle = 'Manage order of Categories'; ?>
    ...
    <div class="col-md-12">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    Manage order of Categories | <a class="text-blue" href="<?php echo Yii::app()->createAbsoluteUrl('admin/category/index'); ?>">Back to Categories</a>
                </h3>
            </div><!-- /.box-header -->
            <div class="box-body">
                <div id="orderMsg"></div>
                    ...
                    <?php if (!empty($categories)) { ?>
                        <ul id="sortable">
                            <?php foreach ($categories as $category) { ?>
                                <li class="ui-state-default" data="<?php echo $category->category_id; ?>">
                                    <i class="fa fa-angle-right"></i> <?php echo $category->category_name; ?>
                                </li>
                            <?php } ?>
                        </ul>
