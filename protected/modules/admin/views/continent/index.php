<?php
$this->pageTitle = 'Manage Continents';

Yii::app()->clientScript->registerScript('search', "
$('.search-form form').submit(function(){
	$('#continent-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
    ...
    <div class="col-md-12">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    Manage Continents | <a class="text-blue" href="<?php echo Yii::app()->createAbsoluteUrl('admin/continent/create'); ?>">Add Continent</a>
                </h3>
                ...
                $this->widget('zii.widgets.grid.CGridView', array(
                    ...
                    'columns' => array(
                        ...
                        array(
                            ...
                            'filter' => CHtml::activeTextField($model, 'continent_name', array('placeholder' => $model->getAttributeLabel('continent_name'), 'style' => 'font-style:italic', 'autocomplete' => 'off', 'class' => 'form-control'))
                        ),
                        array(
                            'name' => 'continent_status',
                            'type' => 'raw',
                            'value' => '($data->continent_status == 0) ? Utils::getLabels(2) : Utils::getLabels(1)',
                            'htmlOptions' => array('style' => 'text-align:center;vertical-align: middle;'),
                            'headerHtmlOptions' => array('style' => 'text-align: center;width:120px'),
                            'filter' => CHtml::activeDropDownList($model, 'continent_status', array(0 => 'Inactive', 1 => 'Active'), array('style' => 'font-style:italic', 'class' => 'form-control', 'empty' => 'Status'))
                        ),
                        array(
                            'header' => 'Edit',
                            'class' => 'CButtonColumn',
