<?php $this->pageTitle = 'Manage order of Currencies'; ?>
    ...
    <div class="col-md-12">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    Manage order of Currencies | <a class="text-blue" href="<?php echo Yii::app()->createAbsoluteUrl('admin/currency/index'); ?>">Back to Currencies</a>
                </h3>
            </div><!-- /.box-header -->
            <div class="box-body">
                <div id="orderMsg"></div>
                    ...
                    <?php if (!empty($currencies)) { ?>
                        <ul id="sortable">
                            <?php foreach ($currencies as $currency) { ?>
                                <li class="ui-state-default" data="<?php echo $currency->currency_id; ?>">
                                    <i class="fa fa-angle-right"></i> <?php echo $currency->currency_code; ?>, <?php echo $currency->currency_name; ?>
                                </li>
                            <?php } ?>
                        </ul>
